...
export const TokenDecode=async (req, res) => {
    let result= DecodeToken("eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6ImVuZ3IucmFiYmlsQHlhaG9vLmNvbSIsInVzZXJfaWQiOiIxMjMiLCJpYXQiOjE3MzAzMDc2MDQsImV4cCI6MTczMjg5OTYwNH0.eWTukpo-qA7-mNPX7ILa91R3uA1t-lsrm_QJ-qJsE-I")
    res.json({token:result});
}
